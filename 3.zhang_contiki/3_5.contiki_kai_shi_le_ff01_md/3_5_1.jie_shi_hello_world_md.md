...
> ①hello\_world\_process是进程的名字。"Hello world process"是进程可读的名字，比如打印到终端时。 ②AUTOSTART\_PROCESSES\(&hello\_world\_process\) 告诉Contiki，当系统启动时自动开始运行hello\_world\_process进程。
